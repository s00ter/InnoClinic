...
using InnoClinic.ServiceApi.Api.DependencyInjection;
using InnoClinic.ServiceApi.BusinessLogic.Validators.ServiceCategoryValidators;
...
try
{
    ...
    builder.Services.AddValidatorsFromAssemblyContaining<CreateServiceCategoryValidator>();
